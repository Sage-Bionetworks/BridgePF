...
public abstract class TaskScheduler {
    ...
    private void addTaskForEachActivityAtTime(List<Task> tasks, ScheduleContext context, DateTime scheduledTime) {
        ...
        if (isInWindow(schedule, scheduledTime)) {
            ...
            DateTime expiresOn = getExpiresOn(schedule, scheduledTime);
            if (expiresOn == null || expiresOn.isAfter(context.getNow())) {
                for (Activity activity : schedule.getActivities()) {
                    ...
                    if (expiresOn != null) {
                        task.setLocalExpiresOn(expiresOn.toLocalDateTime());
    ...
    protected List<Task> trimTasks(List<Task> tasks, Schedule schedule) {
    ...
    private DateTime getExpiresOn(Schedule schedule, DateTime scheduledTime) {
