 ...
 * context, and then runs the validator to compare the two contexts.
 * </p>
 * <p>
...
public class TestingHandler implements UploadValidationHandler {
    ...
    /** Object to clone the production context into a test context. This is configured by Spring. */
    public void setContextCloner(ContextCloner contextCloner) {
        this.contextCloner = contextCloner;
    }
    ...
    public void handle(@Nonnull UploadValidationContext productionContext) throws UploadValidationException {
        // clone context
        UploadValidationContext testContext = contextCloner.clone(productionContext);
