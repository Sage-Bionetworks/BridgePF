...
public class BridgeObjectMapper extends ObjectMapper {
    ...
    public BridgeObjectMapper() {
        ...
        serializers.addDeserializer(ScopeOfSharing.class, new ScopeOfSharingDeserializer());
        serializers.addSerializer(ScopeOfSharing.class, new LowercaseEnumJsonSerializer());
