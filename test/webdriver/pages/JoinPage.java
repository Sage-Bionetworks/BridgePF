...
public class JoinPage extends BasePage {
    ...
    public void enterInvalidDataAfterValidData(String username, String email,
            String password, String confirmPassword) {
        enterFields(username, email, password, confirmPassword);
    ...
    public void assertEmailEmailError() {
        assertTrue("email error is shown", browser
                .findFirst("#emailEmailError").isDisplayed());
    }

    public void assertEmailRequiredError() {
        assertTrue("email is required error is shown",
                browser.findFirst("#emailRequiredError").isDisplayed());
    }

    public void assertPasswordConfirmEqualError() {
        assertTrue("Password confirmation error is displayed", browser
                .findFirst("#passwordConfirmEqualError").isDisplayed());
    }

    private void enterFields(String username, String email, String password,
