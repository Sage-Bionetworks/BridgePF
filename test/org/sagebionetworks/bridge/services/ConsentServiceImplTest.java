...
public class ConsentServiceImplTest {
    ...
    public void canConsent() {
        ...
        SharingOption sharingOption = new SharingOption(SharingScope.ALL_QUALIFIED_RESEARCHERS);
        consentService.consentToResearch(testUser.getStudy(), testUser.getUser(), researchConsent, sharingOption, false);
    ...
    public void canConsentWithSignatureImage() {
        ...
        SharingOption sharingOption = new SharingOption(SharingScope.NO_SHARING);
        consentService.consentToResearch(testUser.getStudy(), testUser.getUser(), signature, sharingOption, false);
        assertTrue(consentService.hasUserConsentedToResearch(testUser.getStudy(), testUser.getUser()));
    ...
    public void cannotConsentIfTooYoung() {
        ...
        SharingOption sharingOption = new SharingOption(SharingScope.SPONSORS_AND_PARTNERS);

        // This will work
        ConsentSignature sig = ConsentSignature.create("Test User", DateUtils.getCalendarDateString(today18YearsAgo), null, null);
        consentService.consentToResearch(study, testUser.getUser(), sig, sharingOption, false);
