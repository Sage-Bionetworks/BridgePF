...
public class TranscribeConsentHandlerTest {
    ...
    public void test() {
        ...
        when(mockOptionsService.getOptions(TestConstants.TEST_STUDY, TEST_HEALTHCODE)).thenReturn(new ParticipantOptionsLookup(
            ImmutableMap.of(
    ...
    public void testNoParticipantOptions() {
        // mock options service
        ParticipantOptionsService mockOptionsService = mock(ParticipantOptionsService.class);
        when(mockOptionsService.getOptions(TestConstants.TEST_STUDY, TEST_HEALTHCODE)).thenReturn(new ParticipantOptionsLookup(Maps.newHashMap()));
    ...
    public void emptyStringSetConvertedCorrectly() {
        ParticipantOptionsService mockOptionsService = mock(ParticipantOptionsService.class);
        when(mockOptionsService.getOptions(TestConstants.TEST_STUDY, TEST_HEALTHCODE)).thenReturn(new ParticipantOptionsLookup(ImmutableMap.of(
