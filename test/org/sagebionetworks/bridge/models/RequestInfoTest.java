...
public class RequestInfoTest {
    ...
    public void canSerialize() throws Exception {
        ...
        assertEquals(ACTIVITIES_REQUESTED_ON.toString(), node.get("activitiesAccessedOn").asText());
        ...
        assertEquals(SIGNED_IN_ON.toString(), node.get("signedInOn").asText());
        assertEquals("-07:00", node.get("timeZone").asText());
