...
public class IntervalTaskSchedulerTest {
    ...
    public void oneWeekAfterEnrollmentAt8amExpireAfter24hours() throws Exception {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusMonths(1)));
    ...
    public void onceScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(1)));
    ...
    public void onceDelayScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(3)));
    ...
    public void onceDelayEndsOnScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusMonths(3)));
        assertEquals(0, tasks.size());
    }
    @Test
    public void onceDelayStartEndsOnScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusMonths(9)));
        assertEquals(0, tasks.size());
    }
    @Test
    ...
    public void onceEventDelayStartEndsOnScheduleWorks() {
        ...
        events.put("survey:AAA:completedOn", asDT("2015-04-02 09:22"));
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusMonths(6)));
    ...
    public void recurringStartsOnScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(4)));
        assertDates(tasks, "2015-03-23 09:40", "2015-03-23 13:40", "2015-03-25 09:40", "2015-03-25 13:40");
    }
    @Test
    public void recurringEndsOnScheduleWorks() {
        ...
        // In this case the endsOn date is before the enrollment. No tasks
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(11)));
    ...
    public void recurringDelayScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(5)));
    ...
    public void recurringDelayStartEndsOnScheduleWorks() {
        ...
        // Schedules in the window without any issue
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(9)));
    ...
    public void recurringEventDelayScheduleWorks() {
        ...
        tasks = schedule.getScheduler().getTasks(plan, getContext(ENROLLMENT.plusDays(16)));
